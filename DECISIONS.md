...
- **Still open, real content gap, needs its own scoping conversation:** no dedicated pages exist for weddings, birthdays, baby showers, or corporate events, despite all four being named in the nav, footer, and the site's own SEO keyword targets. Flagged in the July 8 audit, still unaddressed — the single biggest remaining SEO/AEO/GEO opportunity. See `TASKS.md` NOW #2.
