...
export const PACKAGE_CATALOG: Package[] = [
  // ── General / Birthday / Baby / Corporate / Wedding ──
  {
    ...
    tier: 'Tier 01',
    name: 'Essential',
    tagline: 'Beautiful and complete for birthdays, baby showers & intimate celebrations',
    price: 350,
    priceNote: 'installed',
    color: 'gray',
    features: [
  ...
  },
  {
    ...
    tier: 'Tier 02',
    name: 'Signature',
    tagline: "Our most-loved setup — perfect for quinceañeras, weddings & milestone events",
    price: 900,
    priceNote: 'installed',
    color: 'teal',
    badge: 'Most Loved',
